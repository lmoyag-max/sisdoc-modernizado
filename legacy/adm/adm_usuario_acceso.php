...
<script language="JavaScript1.2">
	...
	function carga() {
	  ...
	  if (ok=="1")
		alert("Acceso de usuario modificado");
	  else if (ok=="0")
	...
	function busca_vigencia(rut, dependencia) {
 		if (rut !=''){
			var rut ;
			var punto = rut.replace('.',''); 
			var punto =punto.replace('.','');
			...
			var rut= guion.substring(0,posicion);
			var valorrut = rut;
			var valordependencia = dependencia;
			document.form1.rutx.value=valorrut;
			document.form1.depx.value=dependencia;
			var sw='BVXD';
			top.window.fr_escon.location.href="adm_consultas_encargado.php?sw="+sw+ "&rutx=" + valorrut+ "&depx=" + valordependencia
		}
	} 
</script>
<style type="text/css">
...
<body onLoad="carga()">
	<form name="form1" method="post"  action="adm_graba_usuario_acceso.php">
...
<br/>
	<table width="50%" border="1" align="center" style="min-width:500px">
        ...
        <tr> 
          ...
          <td valign="top"><select name="cbo_dependencia" class="combo" id="select" onChange="busca_vigencia(document.form1.el_rut.value, document.form1.cbo_dependencia.value);"><option value="0" >--Seleccione dependencia-- </option></select></td>
        <tr> 
        ...
        <tr> 
          <td height="26"  valign="top">Acceso</td>
          <td valign="top">
            Quitar Acceso <input name="acceso" type="checkbox" value="Y">
        </tr>
	</table>
