...
<table width="100%" border="0" background="../images/azul2.jpg">
  <tr> 
     ...
     <!-- <img src="../images/mas.gif" border="0"> -->
        <!--div align="right"><img src="../images/logo40.gif" width="46" height="42"></div> logo del minsal --> 
     </td>
</tr>
</table>
...
oCMenu.makeMenu('top1','','Usuarios','','mainFrame',91,21) //,'../images/mnu_ingreso.gif')
	oCMenu.makeMenu('sub1','top1','Lista de usuarios','adm_listado_usuarios.php','mainFrame',150)
	oCMenu.makeMenu('sub2','top1','Agregar usuario','adm_ingreso_usuarios.php','mainFrame',150)
	oCMenu.makeMenu('sub3','top1','Modificar usuario','adm_modificar_usuarios.php','mainFrame',150)
	oCMenu.makeMenu('sub4','top1','Agregar Dependencia usuario','adm_usuario_dependencia.php','mainFrame',150)
	oCMenu.makeMenu('sub5','top1','Acceso Dependencia usuario','adm_usuario_acceso.php','mainFrame',150)

oCMenu.makeMenu('top2','','Documentos','','mainFrame',91,21) //,'../images/mnu_ingreso.gif')
	oCMenu.makeMenu('sub6','top2','Cambiar Estado de Documento','adm_busca_documento.php','mainFrame',150)

oCMenu.makeMenu('top3','','Dependencias','','mainFrame',91,21) //,'../images/mnu_ingreso.gif')
	oCMenu.makeMenu('sub7','top3','Lista de Dependencias','adm_listado_dependencias.php','mainFrame',150)
	oCMenu.makeMenu('sub8','top3','Agregar Dependencia','adm_ingreso_dependencias.php','mainFrame',150)
	oCMenu.makeMenu('sub9','top3','Modificar Dependencia','adm_modificar_dependencias.php','mainFrame',150)
