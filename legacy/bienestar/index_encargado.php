...
var flujo2= <?php echo $cont; ?>;
  if (flujo2==1)
  {
  alert("Usted no se encuentra registrado, Por favor comuniquese con RRHH.");
  }
  else
  if (flujo2==2)
  {
...
<table width="390" align="center" cellpadding="1" cellspacing="1">
  <tr> 
    <td width="384"><div align="center"> 
        <p><b><font color="#0000A0" size="5" >Encargado de Bienestar<br>
          </font><font size="5" ><img src="imagen/logo_chico.gif" width="96" height="95"></font></b></p>
        </div>
      </td>
  </tr>
</table>
    ...
    <td height="233"> 
      <div id=isample1b style="VISIBILITY: hidden; OVERFLOW: hidden; POSITION: absolute; TOP: -1000px; HEIGHT: 10px; left: 19px;"> 
        ...
        <div id=isample1m style="VISIBILITY: hidden; POSITION: absolute; bgcolor: 'Color [A=255, R=239, G=243, B=247]'"> 
          <form action="verifica_encargado.php" name="formurut" method="post">
            <table cellspacing=0 cellpadding=0 border=0>
              <tbody>
                <tr> 
                ...
                <tr align="center"> 
                  <td colspan="3"> 
				   ...
				   <input type="hidden" name="rut_funcionario" value="<? echo $rut_fun;?>"> 
