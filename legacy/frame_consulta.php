...
$query = "select id_dependencia, SUBSTRING(desc_dependencia, 1, 35) AS desc_dependencia, cod_dependencia_nuevo from dependencia where ofpartes='S'   and vigencia is null order by desc_dependencia  ";
...
// permite rescatar nombre de la dependencia para imprimir en la nomina que se genera  viene en  dato el id_emisor 
if ($sw="IN")
{
