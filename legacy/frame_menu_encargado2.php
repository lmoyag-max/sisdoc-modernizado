...
oCMenu.makeMenu('top1','','Ingresar','','mainFrame',91,21) //,'images/mnu_ingreso.gif')
	  oCMenu.makeMenu('sub1','top1','Ingreso usuarios','ingreso_usuarios.php','mainFrame',150)
	  oCMenu.makeMenu('sub1','top1','Ingreso Dependencias','ingreso_usuarios.php','mainFrame',160)
