...
oCMenu.makeMenu('top1','','Consulta','','mainFrame',91,21) //,'images/mnu_consulta.gif')      
      oCMenu.makeMenu('sub29','top1','Búsqueda Documentos ','busca_doctogab.php?cusuario=<?php echo $cusuario;?>&idusuario=<?php echo $idusuario;?>&idfuncionario=<?php echo $idfuncionario;?>&flujook=<?php echo $flujook;?>&num_int=<?php echo $num_int?>&sw_cons=<?php echo 1;?>&avanza=<?php echo 1;?>','mainFrame',200)		
      oCMenu.makeMenu('sub30','top1','Búsqueda Documentos C/Ult. trámite','busca_doctogab_informe2.php?cusuario=<?php echo $cusuario;?>&idusuario=<?php echo $idusuario;?>&idfuncionario=<?php echo $idfuncionario;?>&flujook=<?php echo $flujook;?>&num_int=<?php echo $num_int?>&sw_cons=<?php echo 1;?>&avanza=<?php echo 1;?>','mainFrame',200)		
      oCMenu.makeMenu('sub31','top1','Informe  documentos ','informe_doc.php?cusuario=<?php echo $cusuario;?>&idusuario=<?php echo $idusuario;?>&idfuncionario=<?php echo $idfuncionario;?>&flujook=<?php echo $flujook;?>&num_int=<?php echo $num_int?>&sw_cons=<?php echo 1;?>&avanza=<?php echo 1;?>','mainFrame',200)		
      oCMenu.makeMenu('sub32','top1','Búsqueda Documentos/Senado','busca_doctogab_informe3.php?cusuario=<?php echo $cusuario;?>&idusuario=<?php echo $idusuario;?>&idfuncionario=<?php echo $idfuncionario;?>&flujook=<?php echo $flujook;?>&num_int=<?php echo $num_int?>&sw_cons=<?php echo 1;?>&avanza=<?php echo 1;?>','mainFrame',200)		
      oCMenu.makeMenu('sub33','top1','Búsqueda Documentos por procedencia','busca_doctogab_informegral.php?cusuario=<?php echo $cusuario;?>&idusuario=<?php echo $idusuario;?>&idfuncionario=<?php echo $idfuncionario;?>&flujook=<?php echo $flujook;?>&num_int=<?php echo $num_int?>&sw_cons=<?php echo 1;?>&avanza=<?php echo 1;?>','mainFrame',200)		
      oCMenu.makeMenu('sub34','top1','Búsqueda auditoria','salen_juridica_2010.php?cusuario=<?php echo $cusuario;?>&idusuario=<?php echo $idusuario;?>&idfuncionario=<?php echo $idfuncionario;?>&flujook=<?php echo $flujook;?>&num_int=<?php echo $num_int?>&sw_cons=<?php echo 1;?>&avanza=<?php echo 1;?>','mainFrame',200)		
