...
function imprime() { 
 ...
 document.form1.action="imprime_nomina_buscada.php";
...
echo '<td heigth="45" valign="top" width="50"><div align="left"><font size="2" color="#FFFFFF"><strong>Observación</strong></font></div></td>';
echo '<td heigth="45" valign="top" width="50"><div align="left"><font size="2" color="#FFFFFF"><strong>Firma</strong></font></div></td>';
echo '</tr>';
echo '</table>';
