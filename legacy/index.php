...
<table width="390" align="center" cellpadding="1" cellspacing="1">
  <tr> 
    <td width="384"><div align="center"> 
        <p><b><font color="#0000A0" size="5" >Sistema de Registro y Seguimiento de Correspondencia<br>
          </font></b><b><font size="5"> 
          <!--img src="imagen/logo_chico.jpg" width="96" height="95"-->
          <tr>
          <div align="center">
	  <img src="imagen/logo_chico.jpg" width="96" height="102"></font></b></p>
          </div>
          </tr>  
      </div>
      </td>
    ...
    <td height="233"> 
      <div id=isample1b style="VISIBILITY: hidden; OVERFLOW: hidden; POSITION: absolute; TOP: -1000px; HEIGHT: 10px; left: 19px;"> 
        ...
        <div id=isample1m style="VISIBILITY: hidden; POSITION: absolute; bgcolor: 'Color [A=255, R=239, G=243, B=247]'"> 
          <form action="verifica_old.php" name="formurut" method="post">
		    <table cellspacing=0 cellpadding=0 border=0>
              <tbody>
                <tr> 
            ...
            <tbody>
              <tr> 
                ...
                <td style="FONT-SIZE: 9px; COLOR: black; FONT-FAMILY: verdana,arial" valign=center nowrap height=7> 
                  ...
                  &nbsp;<b>Departamento de Inform&aacute;tica<BR><center>implemented by JRBI - CADS</center></B></td>
            </tbody>
          </table>
