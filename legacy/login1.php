...
<form action="paso_var1.php" method="POST">
      ...
      <td><table width="400" border="0" align="center" cellpadding="2" cellspacing="0">
          <tr> 
            <td><div align="center"><strong><font color="#0000A0">SEGUIMIENTO 
                DE DOCUMENTO responder</font></strong></div></td>
          </tr>
          <tr> 
            <td><div align="center"><strong><font face="Arial"><img src="file://///Linux80/ximena/imagen/logo_chico.gif" alt="logo_chico.gif (2274 bytes)" WIDTH="95" HEIGHT="87"></font></strong></div></td>
          </tr>
        </table></td>
    </tr>
  </table>
...
bgcolor=red><span style="color:ffffff"><b>Datos incorrectos</b></span> 
          ...
          <tr> 
            ...
            <td width="200"><input type="Text" name="usuario" size="10" maxlength="10"></td>
          </tr>
          <tr> 
