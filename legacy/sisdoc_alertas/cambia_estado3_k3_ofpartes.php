...
// arreglo para guardar informacion del destino cuando es externo y grabar el id_destinatario y no el cod_destinatario
...
function busca_destino()
{
  ...
  if (document.form1.radiodestino[0].checked==true)
	...
	top.window.frame_consultas.location.href="frame_consultas.php?cod="+dep+"&sw="+valor+"&cod_dep="+cd;
	document.form1.Cbo_Destinatario.options.value=	document.form1.Txtdestino.value;
	}
	else
	{
	cd = "E";    
...
if (document.form1.radiodestino[0].checked==true)
	...
	cod="I";
	nuevasel = document.form1.Txtdestino.value;
  	document.form1.val_destino.value= nuevasel;
	top.window.frame_consultas.location.href="frame_consultas.php?cod_dep="+nuevasel+"&sw="+valor+ "&cod="+cod;
...
{
var selindice, nuevalsel,cod;
var temp=document.form1.Cbo_Destinatario;
var valor="DF";
var   cod="E";
...
for (i=0;i<arr_largo;i++){
   temp.options[i]=new Option(arr_nom_dep[i],arr_cod_dep[i])
}
temp.options[0].selected=true
//	top.window.frame_consultas.location.href="frame_consultas.php?cod_dep="+nuevasel+"&des_d="+selindice+"&sw="+valor+"&cod="+cod;
    document.form1.Txtdestino.value=57;
	top.window.frame_consultas.location.href="frame_consultas.php?sw="+valor+"&cod="+cod;
...
for (i=0;i<arr_largo_dest;i++){
   temp.options[i]=new Option(arr_nom_dest[i],arr_cod_dest[i])
}
temp.options[0].selected=true
//top.window.frame_consultas.location.href="frame_consultas.php?cod_dep="+nuevasel+"&sw="+valor+"$cod="+cod;
top.window.frame_consultas.location.href="frame_consultas.php?sw="+valor+"$cod="+cod;
...
<form name="form1" method="post"   action="graba_docto2_k.php">
    <table width="662" border="1" cellpadding="2" cellspacing="0" bgcolor="#3399FF">
      <tr>
        <td width="654"><div align="center"><font color="#FFFFFF" size="4"><b>REENVIO DE /TRAMITE 
            DE DOCUMENTOS</b></font></div></td>
      </tr>
    </table>
    <table width="674" border="1" cellpadding="1" cellspacing="0" bgcolor="#e6eeff">
      <tr> 
        <td width="668" bgcolor="#cadbff"> <table width="100%" border="0" cellspacing="1" cellpadding="2">
            <tr bgcolor="#e6eeff"> 
          ...
          <table width="100%" border="0" cellspacing="1" cellpadding="2">
            <tr> 
              ...
              <td width="260"><font color="#804040"><? echo $rs[funcproced];?></font></td>
            </tr>
          </table>
          <table width="100%" border="0" cellpadding="2" cellspacing="1">
            <tr> 
    ...
    <table width="68%" border="1" bgcolor="e6eeff">
      <tr>            
        <td height="32"><font color="#7777FF"><strong>TRAMITE SOLICITADO</strong></font></td>
      </tr>
    </table>       
    <table width="675" border="0" cellpadding="1" cellspacing="1" bgcolor="e6eeff">
      <tr> 
        <td width="313"><font color="#804040"><strong>ORIGEN</strong></font></td>
        <td width="343"><font color="#804040"><strong>DESTINO</strong></font></td>
      </tr>
    </table>
    <table width="679" border="1" cellpadding="1" cellspacing="0" bgcolor ="e6eeff">
      <tr> 
        <td width="311"><table width="100%" border="0" cellspacing="1" cellpadding="1">
         ...
         <td width="342"><table width="100%" border="0" cellspacing="1" cellpadding="1">
            <tr> 
              <td width="65">&nbsp;</td>
              <td width="71"> <div align="left"><strong>Interno 
                  <input name="radiodestino" type="radio"  value="1" checked onClick="javascript:destino_interno();" >
                  </strong></div></td>
              <td width="114"><strong>Externo 
                  <input name="radiodestino" type="radio"  value="2" onClick="javascript:destino_externo();">
                </strong></td>
              <td width="88"><font face="Arial">
                <input type="button" name="boton2" value="Múltiple" onClick="javascript:ver_destino();">
                </font></td>
            </tr>
            <tr> 
              <td height="39">Destino</td>
              <td> <div align="left"><font face="Arial"> 
			      
                  <!--input name="Txtdestino" type="text" id="Txtdestino2" size="6" maxlength="6" onBlur="busca_destino();cambio1();"-->
            ...
            <tr> 
              <td width="65">Funcionario</td>
              <td width="71" height="42"><font face="Arial"> 
                <select name="Cbo_Func_Destino" class="combo" id="select4" onChange="javascript:cambio3();">
    ...
    <table width="675" border="0" cellspacing="1" cellpadding="1" bgcolor="e6eeff">
      <tr> 
    ...
    <table width="675" border="0" cellspacing="0" cellpadding="1" bgcolor="e6eeff">
      <tr> 
    ...
    <table width="677" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="e6eeff">
      <tr> 
