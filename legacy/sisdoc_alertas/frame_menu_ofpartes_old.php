...
oCMenu.makeMenu('top2','','Gestionar','','mainFrame',91,21) //,'images/mnu_consulta.gif')
		oCMenu.makeMenu('sub23','top2','Documentos por Despachar','multi_pages.php?cusuario=<?php echo $cusuario;?>&idusuario=<?php echo $idusuario;?>&idfuncionario=<?php echo $idfuncionario;?>','mainFrame',
150)
