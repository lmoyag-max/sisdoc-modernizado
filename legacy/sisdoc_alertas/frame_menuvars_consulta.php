...
//echo "***funcionario:" . $idfuncionario . " ***cusuario:" . $cusuario . " **** idusuario:" . $idusuario . " **** id_dependencia:" . $id_dependencia;
	...
	$id_funcionario=$idfuncionario;
	 //echo $num_verde ." amarillo" . $num_amarillo . "rojo" . $num_rojo . "funcionario " . $id_funcionario;
	  //echo" frame" .  $tipo_frame;
?>
  ...
  <tr> 
	...
	<?php //echo $idusuario." dep:". $id_dependencia; ?>
     ...
     <td width="3%">
        ...
        <img src="imagen/logo.jpg" width="46" height="30"></div>
     </td>
     <td width="8%">
...
*************************************/
oCMenu.makeMenu('top1','','Modulo de Consulta','','mainFrame',120,21)//,'images/mnu_informes.gif')
      
      oCMenu.makeMenu('sub30','top1','Búsqueda Avanzada de Documentos','busca_docto.php?cusuario=<?php echo $cusuario;?>&idusuario=<?php echo $idusuario;?>&idfuncionario=<?php echo $idfuncionario;?>&flujook=<?php echo $flujook;?>&num_int=<?php echo $num_int?>&sw_cons=<?php echo 1;?>&avanza=<?php echo 0;?>&avanzada=<?php echo 1;?>&menucons=<?php echo 1;?>','mainFrame',200)
      oCMenu.makeMenu('sub31','top1','Búsqueda por Nómina','buscanomina.php?cusuario=<?php echo $cusuario;?>&idusuario=<?php echo $idusuario;?>&idfuncionario=<?php echo $idfuncionario;?>&consulta=<?php echo 1;?>
		','mainFrame',200)
oCMenu.makeMenu('sub030','top1','Búsqueda Global de Documentos','busca_docto.php?cusuario=<?php echo $cusuario;?>&idusuario=<?php echo $idusuario;?>&idfuncionario=<?php echo $idfuncionario;?>&flujook=<?php echo $flujook;?>&num_int=<?php echo $num_int?>&sw_cons=<?php echo 1;?>&avanza=<?php echo 1;?>&menucons=<?php echo 1;?>','mainFrame',200)		
		oCMenu.makeMenu('sub32','top1','Expedientes','busca_expediente2.php?cusuario=<?php echo $cusuario;?>&idusuario=<?php echo $idusuario;?>&idfuncionario=<?php echo $idfuncionario;?>&opcion=1','mainFrame',200)
		oCMenu.makeMenu('sub33','top1','Invitaciones','buscainvitacion.php?cusuario=<?php echo $cusuario;?>&idusuario=<?php echo $idusuario;?>&idfuncionario=<?php echo $idfuncionario;?>&sw_fecha=<?php echo 0;?>
		','mainFrame',200)
		 oCMenu.makeMenu('sub34','top1','Documentos Pendientes','busca_pend.php?cusuario=<?php echo $cusuario;?>&idusuario=<?php echo $idusuario;?>&idfuncionario=<?php echo $idfuncionario;?>
		','mainFrame',200)
		oCMenu.makeMenu('sub35','top1','Busqueda de Documentos Cerrados','busca_docto.php?cusuario=<?php echo $cusuario;?>&idusuario=<?php echo $idusuario;?>&idfuncionario=<?php echo $idfuncionario;?>&flujook=<?php echo $flujook;?>
		&num_int=<?php echo $num_int?>&sw_cons=<?php echo 2;?>&menucons=<?php echo 1;?>','mainFrame',200)
		oCMenu.makeMenu('sub36','top1','Gestión de documentos','busca_gestion.php?cusuario=<?php echo $cusuario;?>&idusuario=<?php echo $idusuario;?>&idfuncionario=<?php echo $idfuncionario;?>
		','mainFrame',200)
		 oCMenu.makeMenu('sub37','top1','Busquedas Tramites Despachados','busca_tramites_despachados.php?cusuario=<?php echo $cusuario;?>&idusuario=<?php echo $idusuario;?>&idfuncionario=<?php echo $idfuncionario;?>
		','mainFrame',200)

		    oCMenu.makeMenu('sub39','top1','Informe documentos en alerta','busca_documento_alertas.php?cusuario=<?php echo $cusuario;?>&idusuario=<?php echo $idusuario;?>&id_funcionario=<?php echo $idfuncionario;?>&id_dependencia=<?php echo $id_dependencia;?>
		','mainFrame',200)

//oCMenu.makeMenu('sub37','top1','Facturas Pendientes','busca_pend_fact.php?cusuario=<?php echo $cusuario;?>&idusuario=<?php echo $idusuario;?>&idfuncionario=<?php echo $idfuncionario;?>
	//	','mainFrame',200)
	//		   oCMenu.makeMenu('sub40','top1','Consulta Facturas','busca_factura_prueba.php?cusuario=<?php echo $cusuario;?>&idusuario=<?php echo $idusuario;?>&idfuncionario=<?php echo $idfuncionario;?>&flujook=<?php echo $flujook;?>&num_int=<?php echo $num_int?>&sw_cons=<?php echo 1;?>&avanza=<?php echo 1;?>','mainFrame',200)
