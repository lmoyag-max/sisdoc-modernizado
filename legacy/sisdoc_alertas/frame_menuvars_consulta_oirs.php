  ...
  <tr> 
	...
	<?php //echo $idusuario." dep:". $id_dependencia; ?>
     ...
     <td width="3%">
        ...
        <img src="imagen/logo.jpg" width="46" height="31"></div>
     </td>
     <td width="8%">
...
//		&flujook=<?php echo $flujook;?>','mainFrame',150)
...
oCMenu.makeMenu('top1','','Modulo de Consulta','','mainFrame',120,21)//,'images/mnu_informes.gif')
      ...
      oCMenu.makeMenu('sub31','top1','Búsqueda por Nómina','buscanomina.php?cusuario=<?php echo $cusuario;?>&idusuario=<?php echo $idusuario;?>&idfuncionario=<?php echo $idfuncionario;?>&consulta=<?php echo 1;?>
		','mainFrame',200)
oCMenu.makeMenu('sub030','top1','Búsqueda Global de Documentos','busca_docto_oirs.php?cusuario=<?php echo $cusuario;?>&idusuario=<?php echo $idusuario;?>&idfuncionario=<?php echo $idfuncionario;?>&flujook=<?php echo $flujook;?>&num_int=<?php echo $num_int?>&sw_cons=<?php echo 1;?>&avanza=<?php echo 1;?>&menucons=<?php echo 1;?>','mainFrame',200)		
