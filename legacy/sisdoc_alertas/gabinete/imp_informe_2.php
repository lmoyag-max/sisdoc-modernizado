...
<table align="center" width="695" height="38" border="0">
  <tr> 
...
<table width="659"  border="1" align="center"  cellspacing="1" cellpadding="1" bgcolor="#E6EEFF">
  <tr bgcolor="#3399FF"> 
    <td width="95"  height="33"><font color="#FFFFFF" size="2" ><strong>Tipo doc.</strong></font></td>
    <td width="68" height="33"><font color="#FFFFFF" size="2"><strong>Fecha doc.</strong></font></td>
    ...
    <td width="44"  height="33"><font color="#FFFFFF" size="2"><strong>Nro Externo</strong></font></td>
    <td width="140"  height="33"><font color="#FFFFFF" size="2"><strong>Materia</strong></font></td>
    <td width="76"  height="33"><font color="#FFFFFF" size="2"><strong>Fecha Ingreso</strong></font></td>
    <td width="86"  height="33"><font color="#FFFFFF" size="2"><strong>Procedencia</strong></font></td>
    <td width="83"  height="33"><font color="#FFFFFF" size="2"><strong>Destino</strong></font></td>
    <td width="57"><font color="#FFFFFF" size="2"><strong>N&oacute;mina</strong></font></td>
  </tr>
<!--/table-->
<?php 
$p=1;
...
echo '<tr bgcolor="#3399FF">';
    ...
    echo '<td width="95"  height="33"><font color="#FFFFFF" size="2" ><strong>Tipo doc.</strong></font></td>';
    echo '<td width="68" height="33"><font color="#FFFFFF" size="2"><strong>Fecha doc.</strong></font></td>';
   // echo '<td width="42"  height="33"><strong><font color="#FFFFFF" size="2">Nro Interno</font></strong></td>';
    ...
    echo '<td width="44"  height="33"><font color="#FFFFFF" size="2"><strong>Nro Externo</strong></font></td>';
    echo '<td width="140"  height="33"><font color="#FFFFFF" size="2"><strong>Materia</strong></font></td>';
    echo '<td width="76"  height="33"><font color="#FFFFFF" size="2"><strong>Fecha Ingreso</strong></font></td>';
    echo '<td width="86"  height="33"><font color="#FFFFFF" size="2"><strong>Procedencia</strong></font></td>';
    echo '<td width="83"  height="33"><font color="#FFFFFF" size="2"><strong>Destino</strong></font></td>';
    echo '<td width="57"><font color="#FFFFFF" size="2"><strong>N&oacute;mina</strong></font></td>';
echo '</tr>';
//echo '</table>';

//echo '<table width="700" align="center" border="1" cellspacing="1" cellpadding="1" bgcolor="#E6EEFF">';
$cont=0;
}?>
<tr> 
            <td ><font size="2">
			  ...
			  echo $reg[desc_tipo_documento]; ?> </font>
			  </td>
              <td ><font size="2">
			  ...
			  <td><font size="2"> <? echo $rsp[num_externo];?></font> </td>
			  <td ><font size="2"><? echo $rsp[materia]; ?></font></td>
			   <td > <font size="2">
			   <? 
		    ...
		    <td> <font size="2">
			<? echo $rsp[id_nomina_despacho];?> </font>
			</td>
