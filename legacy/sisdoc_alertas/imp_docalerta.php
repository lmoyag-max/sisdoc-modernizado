...
<table width="659"  border="1" align="center"  cellspacing="1" cellpadding="1" bgcolor="#E6EEFF">
  <tr bgcolor="#3399FF"> 
      <td width="8%" height="33"><strong><font color="#FFFFFF" size="2">Tipo doc. </font></strong></td>
	  <td width="8%" height="33"><strong><font color="#FFFFFF" size="2">Nómina</font></strong></td>
	  <td width="8%" height="33"><strong><font color="#FFFFFF" size="2">Nro Interno</font></strong></td>
	  <td width="8%" height="33"><strong><font color="#FFFFFF" size="2">Nro Externo</font></strong></td>
	  <td width="8%" height="33"><strong><font color="#FFFFFF" size="2">Fecha doc.</font></strong></td>
	  <td width="100%" height="33"><strong><font color="#FFFFFF" size="2">Materia</font></strong></td>
...
for ($i =0 ; ($i <= $Totreg); $i++) 
   {
     if($casilla[$i]!=null) 
		...
		$rs_dep="exec busca_segdoc_alerta'" . $seg . "'";
		...
		if($cont ==7)
		  ...
		  <tr> 
			  ...
			  <? echo $rsp[desc_tipo_documento]; ?> </td>
			  <td width="8%" height="33"> 
