...
// document.form1.action="imprime_nomina_prueba";
  document.form1.action="imprime_nomina_prueba_factura.php";
  ...
  <tr> 
    ...
    <!--td width="350"> 
      <div id="volver" style="position:absolute; z-index:1; visibility: visible; overflow: auto; background-color: #ffffff; layer-background-color: #ffffff; border: 1px none #000000; left: 709px; top: 26px; width: 119px; height: 41px;"> 
          <table width="42%" height="35" align="right">
          <tr> 
            <td align="right"><strong><?php echo '<a href="imp_nomina_prueba_factura?cusuario=' . $cusuario .
...
//echo '<td heigth="45" valign="top" width="50"><div align="left"><font size="2" color="#FFFFFF"><strong>Tipo Distrib.</strong></font></div></td>';
...
//echo '<td width="50"  valign="top" heigth="45">
	//  <div align="left"><font color="#000000" size="2">Tipo Distrib.</font></div></td>';
echo '<td width="70"  valign="top" heigth="45">
...
?>
  <tr> 
    ...
    <!--td align="left" width="50"  valign="middle"><font size="2">
	  <?php echo $qr[desc_tipo_distribucion] ; ?>
	</td-->
...
<input type="hidden" name="idseguim" value = "<?php echo $idseguim ;?>">
<input type="hidden" name="origen" value = "<?php echo $origen ;?>">
<input type="hidden" name="iddocum" value = "<?php echo  $iddocum ; ?>">
