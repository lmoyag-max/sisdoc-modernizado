...
<table width="720" border="0" align="center" cellpadding="1" cellspacing="1">
  <tr> 
    ...
    <td width="310"> <div align="center"><strong><font color="#0000A0" size="3">NOMINA DE FACTURAS DESPACHADOS </font></strong></div></td>
  ...
  <table width="720" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr> 
      ...
      <td width="198"><div align="right"></div></td>
    </tr>
  </table>
...
<table width="720" border="0" align="center" cellpadding="1" cellspacing="1">
  <tr> 
    ...
    <td width="350"> 
      <div id="volver" style="position:absolute; z-index:1; visibility: visible; overflow: auto; background-color: #ffffff; layer-background-color: #ffffff; border: 1px none #000000; left: 790px; top: 1px; width: 119px; height: 41px;"> 
          <table width="42%" height="35" align="right">
          <tr> 
            <td align="right"><strong><?php echo '<a href="multi_pages_factura.php?cusuario=' . $cusuario .
...
$rs_recep="exec busca_nomina_despacho_factura '" . $xx .  "','" . $nomina . "'";
...
echo '<td width="45" height="28"  valign="top">
	 <div align="left"><font color="#000000" size="2">Nro Factura</font></div></td>';
echo '<td width="45" height="28"  valign="top">
	 <div align="left"><font color="#000000" size="2">Proveedor</font></div></td>';	 
echo '<td width="70"  valign="top" heigth="45"> 
	<div align="left"><font color="#000000" size="2">Tema<br>factura</font></div></td>';
echo '<td width="150"  valign="top" heigth="45"> 
      <div align="left"><font color="#000000" size="2">Descripción</font></div></td>';
echo '<td width="70"  valign="top" heigth="45">
...
echo '<td width="50"  valign="top" heigth="45">
	  <div align="left"><font color="#000000" size="2">Fecha<br>Factura</font></div></td>';
echo '<td width="70"  valign="top" heigth="45">
