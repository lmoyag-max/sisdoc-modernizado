...
function imprime() {
 // permite imprimir sin mostrar boton de impresion 
...
/*   $rs=mssql_fetch_array($qp);
   $tot =mssql_num_rows($qp);
   if ($tot==1)
   { $nombreemisor =$rs[desc_dependencia];}
  */  
?>
...
<table width="720" border="0" align="center" cellpadding="1" cellspacing="1">
  <tr> 
    ...
    <td width="310"> <div align="center"><strong><font color="#0000A0" size="3"><? echo "Emitido por : " . $nombreemisor ;?>  </font></strong></div></td>
    <td width="179"><div align="right"></div></td>
  </tr>
</table>
...
<table width="720" border="0" align="center" cellpadding="1" cellspacing="1">
  <tr> 
    <td width="157" height="59"> 
      <div id="impresion" style="position:absolute; z-index:1; visibility: visible; overflow: auto; background-color: #ffffff; layer-background-color: #ffffff; border: 1px none #000000; left: 655px; top: 170px; width: 178px; height: 39px;"> 
