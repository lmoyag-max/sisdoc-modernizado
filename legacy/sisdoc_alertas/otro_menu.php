...
oCMenu.makeMenu('top1','','Ingresar','','mainFrame',91,21) //,'images/mnu_ingreso.gif')
	  oCMenu.makeMenu('sub11','top1','Ingreso Oficina de partes','ingreso_ofpartes_k.php?cusuario=<?php echo $cusuario;	?>&idusuario=<?php echo $idusuario;?>&idfuncionario=<?php echo $idfuncionario;?>&flujook=<?php echo $flujook;?>&num_int=<?php echo $num_int;?>&num_exp=<?php echo 0;?>&sw_ext=0','mainFrame',150)
		...
		oCMenu.makeMenu('sub13','top1','Modificación de Documento','modifica_docto.php?cusuario=<?php echo $cusuario;?>&idusuario=<?php echo $idusuario;?>&idfuncionario=<?php echo $idfuncionario;?>&flujook=<?php echo $flujook;?>&num_int=<?php echo $num_int;?>','mainFrame',150)		
		oCMenu.makeMenu('sub14','top1','Modificación de Tramite','busca_tramites.php?cusuario=<?php echo $cusuario;?>&idusuario=<?php echo $idusuario;?>&idfuncionario=<?php echo $idfuncionario;?>&flujook=<?php echo $flujook;?>','mainFrame',150)		
