...
echo '<frame src="frame_menuvars_consulta.php?idusuario=' . $idusu .
	   ...
	   '&id_dependencia=' .	 $id_dependencia .'&tipo_frame=' .	 $tipo_frame .  '" name="frame_menuvars_consulta" scrolling="NO" noresize>' . "\n";
