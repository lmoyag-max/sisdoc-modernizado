...
echo '<frame src="frame_menuvars_consulta_oirs.php?idusuario=' . $idusu .
	   ...
	   '&idfuncionario=' .	 $idfunc .  '&num_int=' . $num . 
	   	   '&id_dependencia=' .	 $id_dependencia .'&tipo_frame=' .	 $tipo_frame .  '" name="frame_menuvars_consulta_oirs" scrolling="NO" noresize>' . "\n";

	  // '" name="frame_menuvars_consulta_oirs" scrolling="NO" noresize>';
