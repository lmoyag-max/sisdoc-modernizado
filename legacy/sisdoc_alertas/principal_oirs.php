...
<?php
// para ver variables tiene 55 pero se achica para que no se vea tan grande en pantalla///echo '<frameset rows="55,45,*" frameborder="no" border="0" framespacing="0">';
...
echo '<frame src="frame_menuvars_oirs.php?idusuario=' . $idusu .
       '&cusuario=' . $cusu . '&idfuncionario=' . $idfunc . '&flujook=' . $flujo .
	   '&val_funcionario=' . $cbo . '&val_procedencia=' . $cbo1 . 
	   '&val_funcionario1=' . $cbo2 . '&val_destino=' . $cbo3 .
       '&tipo_procedencia=' .	 $tipop . '&tipo_destino=' . $tipod . 
	   '&idfuncionario=' .	 $idfunc .  '&num_int=' . $num . 
  	   '&id_dependencia=' .	 $id_dependencia . '&tipo_frame=' .	 $tipo_frame .   '" name="frame_menuvars_oirs" scrolling="NO" noresize>';

//	   '" name="frame_menuvars_oirs" scrolling="NO" noresize>';
