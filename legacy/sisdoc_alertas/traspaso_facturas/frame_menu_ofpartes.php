...
<table width="100%" border="0" background="images/azul2.jpg">
  <tr> 
    <td width="15%"> <div id="anchorie" style="position:relative; width:0; height:0; left: 4px; top: 19px;"></div></td>
    <td width="56%" align="right"> 
      <?php //echo $idusuario." dep:". $id_dependencia; ?>
      <select id="dep" name="dep" onChange="cambio();">
      </select> </td>
    <td width="13%"> <table border="0" width="81%">
        <tr> 
          <td bgcolor="#66FF00" width="33%" align="center"><a href="lista_doc2.php?temp=1&cusuario=<?php echo $cusuario; 
		 ?>&idusuario=<?php echo $idusuario; ?>&idfuncionario=<?php echo $idfuncionario; ?>&txtagno=<?php echo $txtagno; ?>&tipo_frame=<?php echo $tipo_frame; 
		 ?>&num_pag=1" target="mainFrame"><?php echo $num_verde; ?></a> </td>
          <td bgcolor="#FFFF00" width="33%" align="center"><a href="lista_doc2.php?temp=2&cusuario=<?php echo $cusuario; 
		 ?>&idusuario=<?php echo $idusuario; ?>&idfuncionario=<?php echo $idfuncionario; ?>&txtagno=<?php echo $txtagno; ?>&tipo_frame=<?php echo $tipo_frame; 
		 ?>&num_pag=1" target="mainFrame"><?php echo $num_amarillo; ?></a> </td>
          <td bgcolor="#FF0000" width="33%" align="center"><a href="lista_doc2.php?temp=3&cusuario=<?php echo $cusuario; 
		 ?>&idusuario=<?php echo $idusuario; ?>&idfuncionario=<?php echo $idfuncionario; ?>&txtagno=<?php echo $txtagno; ?>&tipo_frame=<?php echo $tipo_frame; 
		 ?>&num_pag=1" target="mainFrame"><?php echo $num_rojo; ?></a> </td>
        </tr>
      </table></td>
    <td width="3%"> <div align="right"> 
        <!--img src="images/logo40.gif" width="46" height="42"-->
        <img src="imagen/logo.jpg" width="46" height="31"></div></td>
    <td width="8%"> <div align="left" ><a href="../salir.php" ><img src="images/boton_salir.gif"  alt="Salir" width="26" height="26" onMouseOver="this.style.cursor='hand';"></a></div></td>
  </tr>
</table>
...
oCMenu.makeMenu('top1','','Ingresar','','mainFrame',91,21) //,'images/mnu_ingreso.gif')
	  //oCMenu.makeMenu('sub11','top1','Ingreso Oficina de partes','ingreso_ofpartes_k_2.php?cusuario=<?php echo $cusuario;	?>&idusuario=<?php echo $idusuario;?>&idfuncionario=<?php echo $idfuncionario;?>&flujook=<?php echo $flujook;?>&num_int=<?php echo $num_int;?>&num_exp=<?php echo 0;?>&sw_ext=0','mainFrame',150)
	  oCMenu.makeMenu('sub11','top1','Ingreso Oficina de partes','ingreso_ofpartes_k.php?cusuario=<?php echo $cusuario;	?>&idusuario=<?php echo $idusuario;?>&idfuncionario=<?php echo $idfuncionario;?>&flujook=<?php echo $flujook;?>&num_int=<?php echo $num_int;?>&num_exp=<?php echo 0;?>&sw_ext=0','mainFrame',150)
		oCMenu.makeMenu('sub12','top1','Ingreso Numero Oficial ','modifica_docto_ofpartes.php?cusuario=<?php echo $cusuario;?>&idusuario=<?php echo $idusuario;?>&idfuncionario=<?php echo $idfuncionario;?>&flujook=<?php echo $flujook;?>&num_int=<?php echo $num_int;?>&mensaje=<?php echo "1";?>','mainFrame',150)		
		oCMenu.makeMenu('sub13','top1','Modificación Numero Oficial','modifica_docto_modpartes.php?cusuario=<?php echo $cusuario;?>&idusuario=<?php echo $idusuario;?>&idfuncionario=<?php echo $idfuncionario;?>&flujook=<?php echo $flujook;?>&num_int=<?php echo $num_int;?>','mainFrame',150)		
		oCMenu.makeMenu('sub14','top1','Modificación de Documento','modifica_docto.php?cusuario=<?php echo $cusuario;?>&idusuario=<?php echo $idusuario;?>&idfuncionario=<?php echo $idfuncionario;?>&flujook=<?php echo $flujook;?>&num_int=<?php echo $num_int;?>','mainFrame',150)		
		oCMenu.makeMenu('sub15','top1','Modificación de Tramite','busca_tramites.php?cusuario=<?php echo $cusuario;?>&idusuario=<?php echo $idusuario;?>&idfuncionario=<?php echo $idfuncionario;?>&flujook=<?php echo $flujook;?>','mainFrame',150)		

oCMenu.makeMenu('top2','','Gestionar','','mainFrame',91,21) //,'images/mnu_consulta.gif')
		oCMenu.makeMenu('sub23','top2','Documentos por Despachar','multi_pages.php?cusuario=<?php echo $cusuario;?>&idusuario=<?php echo $idusuario;?>&idfuncionario=<?php echo $idfuncionario;?>','mainFrame',150)
		...
		oCMenu.makeMenu('sub25','top2','Documentos por Derivar','busca_documento_a_ofpartes.php?cusuario=<?php echo $cusuario;?>&idusuario=<?php echo $idusuario;?>&idfuncionario=<?php echo $idfuncionario;?>','mainFrame',150)

oCMenu.makeMenu('top3','','Consultar','','mainFrame',95,21)//,'images/mnu_informes.gif')
//	    oCMenu.makeMenu('sub30','top3','Busqueda Avanzada de Documentos','busca_docto.php?cusuario=<?php echo $cusuario;?>&idusuario=<?php echo $idusuario;?>&idfuncionario=<?php echo $idfuncionario;?>&flujook=<?php echo $flujook;?>
//		&num_int=<?php echo $num_int?>&sw_cons=<?php echo 1;?>','mainFrame',200)
        oCMenu.makeMenu('sub31','top3','Busqueda por Nómina','buscanomina.php?cusuario=<?php echo $cusuario;?>&idusuario=<?php echo $idusuario;?>&idfuncionario=<?php echo $idfuncionario;?>
		','mainFrame',200)
		...
		oCMenu.makeMenu('sub32','top3','Búsqueda de Documentos a Scanear','ingresar_scaner_docto.php?cusuario=<?php echo $cusuario;?>&idusuario=<?php echo $idusuario;?>&idfuncionario=<?php echo $idfuncionario;?>&flujook=<?php echo $flujook;?>&num_int=<?php echo $num_int;?>&mensaje=<?php echo "1";?>','mainFrame',200)		

		oCMenu.makeMenu('sub33','top3','Expedientes','busca_expediente2.php?cusuario=<?php echo $cusuario;?>&idusuario=<?php echo $idusuario;?>&idfuncionario=<?php echo $idfuncionario;?>&opcion=1','mainFrame',200)
		oCMenu.makeMenu('sub34','top3','Invitaciones','buscainvitacion.php?cusuario=<?php echo $cusuario;?>&idusuario=<?php echo $idusuario;?>&idfuncionario=<?php echo $idfuncionario;?>&sw_fecha=<?php echo 0;?>
		','mainFrame',200)
		 oCMenu.makeMenu('sub35','top3','Documentos Pendientes','busca_pend.php?cusuario=<?php echo $cusuario;?>&idusuario=<?php echo $idusuario;?>&idfuncionario=<?php echo $idfuncionario;?>
		','mainFrame',200)
		oCMenu.makeMenu('sub36','top3','Busqueda de Documentos Cerrados','busca_docto.php?cusuario=<?php echo $cusuario;?>&idusuario=<?php echo $idusuario;?>&idfuncionario=<?php echo $idfuncionario;?>&flujook=<?php echo $flujook;?>
		&num_int=<?php echo $num_int?>&sw_cons=<?php echo 2;?>','mainFrame',200)
		
		oCMenu.makeMenu('sub37','top3','Gestión de documentos','busca_gestion.php?cusuario=<?php echo $cusuario;?>&idusuario=<?php echo $idusuario;?>&idfuncionario=<?php echo $idfuncionario;?>
		','mainFrame',200)
...
//	    oCMenu.makeMenu('sub51','top5','Ingreso Facturas','ingreso_facturas_ofpartes.php?cusuario=<?php echo $cusuario;	?>&idusuario=<?php echo $idusuario;?>&idfuncionario=<?php echo $idfuncionario;?>&flujook=<?php echo $flujook;?>&num_int=<?php echo 0;?>&num_exp=<?php echo 0;?>','mainFrame',200)
		...
		&num_int=<?php echo $num_int?>&sw_cons=<?php echo 1;?>','mainFrame',200)
		oCMenu.makeMenu('sub55','top5','Eliminar trámite facturas','busca_factura_el.php?cusuario=<?php echo $cusuario;?>&idusuario=<?php echo $idusuario;?>&idfuncionario=<?php echo $idfuncionario;?>&flujook=<?php echo $flujook;?>
		&num_int=<?php echo $num_int?>&sw_cons=<?php echo 2;?>','mainFrame',200)
		oCMenu.makeMenu('sub56','top5','Facturas por Despachar','multi_pages_facturas.php?cusuario=<?php echo $cusuario;?>&idusuario=<?php echo $idusuario;?>&idfuncionario=<?php echo $idfuncionario;?>','mainFrame',200)
	     oCMenu.makeMenu('sub57','top5','Consulta Facturas','busca_factura_prueba.php?cusuario=<?php echo $cusuario;?>&idusuario=<?php echo $idusuario;?>&idfuncionario=<?php echo $idfuncionario;?>&flujook=<?php echo $flujook;?>&num_int=<?php echo $num_int?>&sw_cons=<?php echo 1;?>&avanza=<?php echo 1;?>','mainFrame',200)
	    oCMenu.makeMenu('sub58','top5','Buscar nomina','buscanomina_facturas.php?cusuario=<?php echo $cusuario;?>&idusuario=<?php echo $idusuario;?>&idfuncionario=<?php echo $idfuncionario;?>','mainFrame',200)
