...
oCMenu.makeMenu('top2','','Gestionar','','mainFrame',91,21) //,'images/mnu_consulta.gif')
	...
	//    oCMenu.makeMenu('sub20','top2','Documentos por Recepcionar','cambio_recep.php?cusuario=<?php echo $cusuario;?>&idusuario=<?php echo $idusuario;?>&idfuncionario=<?php echo $idfuncionario;?>','mainFrame',150)
//	    oCMenu.makeMenu('sub21','top2','Documentos Recepcionados','cambio_recib.php?cusuario=<?php echo $cusuario;?>&idusuario=<?php echo $idusuario;?>&idfuncionario=<?php echo $idfuncionario;?>','mainFrame',150)
...
oCMenu.makeMenu('top3','','Consultar','','mainFrame',95,21)//,'images/mnu_informes.gif')
      ...
      oCMenu.makeMenu('sub31','top3','Búsqueda por Nómina','buscanomina.php?cusuario=<?php echo $cusuario;?>&idusuario=<?php echo $idusuario;?>&idfuncionario=<?php echo $idfuncionario;?>
		','mainFrame',200)
     oCMenu.makeMenu('sub030','top3','Búsqueda Global de Documentos','busca_docto_oirs.php?cusuario=<?php echo $cusuario;?>&idusuario=<?php echo $idusuario;?>&idfuncionario=<?php echo $idfuncionario;?>&flujook=<?php echo $flujook;?>&num_int=<?php echo $num_int?>&sw_cons=<?php echo 1;?>&avanza=<?php echo 1;?>','mainFrame',200)		
		...
		','mainFrame',200)
		// oCMenu.makeMenu('sub34','top3','Documentos Pendientes','busca_pend1.php?cusuario=<?php echo $cusuario;?>&idusuario=<?php echo $idusuario;?>&idfuncionario=<?php echo $idfuncionario;?>
		//','mainFrame',200)
		...
		//','mainFrame',200)
		//oCMenu.makeMenu('sub39','top3','Informe Documentos Ingresados','busca_ingresos.php?cusuario=<?php echo $cusuario;?>&idusuario=<?php echo $idusuario;?>&idfuncionario=<?php echo $idfuncionario;?>
		//','mainFrame',200)
      //oCMenu.makeMenu('sub042','top3','prueba de busqueda con fecha limitada','buscar_datos_prueba.php?cusuario=<?php echo $cusuario;?>&idusuario=<?php echo $idusuario;?>&idfuncionario=<?php echo $idfuncionario;?>&flujook=<?php echo $flujook;?>&num_int=<?php echo $num_int?>&sw_cons=<?php echo 1;?>&avanza=<?php echo 1;?>','mainFrame',200)		
