...
$rs_tram="exec busca_estado_tramite_factura '" . $id_doc . "'";
echo $rs_tram; 
...
$documento_query = "exec ing_respaldo_factura '" . $id_doc . "','" . $reg_datos["id_tema_fact"] . "','" . 
$reg_datos["id_usuario"] . "','"  . $reg_datos["num_factura"] . "','" ."','" . $reg_datos["fecha_factura"] .
 "','" .  $reg_datos["fecha_sistema"] . "','" .
ltrim($reg_datos["descripcion"]) . "','" . $id_seg . "','" . $reg_datos["id_procedencia"] . "','" .
...
$sw_grabado = 1;
	...
	echo '<form name="form1" method="post" action="fac_enc_el.php">' . "\n";
