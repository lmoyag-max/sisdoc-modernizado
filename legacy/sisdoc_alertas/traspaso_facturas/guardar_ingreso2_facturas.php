...
// facturas 
$Cbo_Estado_fact=1; 
//$query_factura="exec ingreso_facturas '"  . $Cbo_Cbo_tema_facturas . "','" . $aux_rut . "','" . $Cbo_Estado_fact . "','"  . $num_factura . "','" .  $monto .   "','" . $TxtMateria .  "','" . $Fecha_fact.  "','" . $Fecha_recep . "','" . $fechasistema ."','" . $fechasistema ."','" .$xx . "','"   . $op . "'";
//$query_factura="exec ingreso_facturas2 '"  . $Cbo_tipo_facturas . "','" .$Cbo_tema_facturas . "','" . $aux_rut . "','" . $Cbo_Estado_fact . "','"  . $num_factura . "','" .  $monto .   "','" . $TxtMateria .  "','" . $Fecha_fact.  "','" . $Fecha_recep . "','" . $fechasistema ."','" . $fechasistema ."','" .$xx . "','"   . $op . "'";
$query_factura="exec ingreso_facturas3 '"  . $Cbo_tipo_facturas . "','" .$Cbo_tema_facturas . "','" . $aux_rut . "','" . $Cbo_Estado_fact . "','"  . $num_factura . "','" .  $monto .   "','" . $TxtMateria .  "','" . $Fecha_fact.  "','" . $Fecha_recep . "','". $fecharec2 ."','" . $fechasistema ."','" . $fechasistema ."','" .$xx . "','"   . $op . "'";
//echo $query_factura ;
...
if ($flujo==0)
	...
	echo '<form name="form1" method="post" action="ingreso_facturas.php">' . "\n";
