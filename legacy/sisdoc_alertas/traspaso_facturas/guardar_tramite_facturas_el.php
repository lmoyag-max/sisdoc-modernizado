...
{
   $grabado=0;
   $query_doc="select max(id_detalle) as doc from detalle_factura where id_factura =" . $id_doc;
   ...
   if($reg_doc["doc"]==$id_seg)
   {
	...
	$documento_query = "exec ing_respaldo_factura '" . $reg_datos["id_factura"] . "','" . $reg_datos["id_tema_fact"] . "','" . 
