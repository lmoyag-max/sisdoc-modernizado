...
function imprime() { 
 ...
 document.form1.action="imprime_nomina_factura.php";
...
$rs_recep="exec busca_nomina_despacho2_factura '" . $xx .  "','" . $nomina . "'";
...
echo '<tr>'; 
eecho '<td height="45" valign="top" width="33"><div align="left"><font size="2" color="#FFFFFF"><strong>Nº Factura</strong></font></div></td>';
