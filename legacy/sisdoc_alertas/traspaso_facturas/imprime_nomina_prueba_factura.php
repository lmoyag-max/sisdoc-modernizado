  ...
  <table width="700" border="0" align="center" cellpadding="1" cellspacing="1">
    ...
    <td width="350"> 
      <div id="volver" style="position:absolute; z-index:1; visibility: visible; overflow: auto; background-color: #ffffff; layer-background-color: #ffffff; border: 1px none #000000; left: 709px; top: 26px; width: 119px; height: 41px;"> 
          <table width="42%" height="35" align="right">
          <tr> 
            <!--td align="right"><strong><?php echo '<a href="imp_nomina_prueba_factura.php?cusuario=' . $cusuario .
			'&idusuario=' . $xx . '&idfuncionario=' . $fun . '">Volver</a>'; ?></strong></td-->
			 <td align="right"><strong><?php echo '<a href="deriva_sdoc_factura_prueba.php?cusuario=' . $cusuario .
			'&idusuario=' . $xx . '&idfuncionario=' . $fun .  '&iddocum=' . $iddocum .  '&num_int=' . $num_int .  '&idseguim=' . $idseguim .  '&origen=' . $origen.   '">Volver</a>'; ?></strong></td>
          </tr>
        </table>
	   </div>
		</td>  	
