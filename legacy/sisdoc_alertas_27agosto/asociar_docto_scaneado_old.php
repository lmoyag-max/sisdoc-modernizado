...
$txtnomina =$txtnomina;
$iddocum=$iddocum;
//echo "procedencia" . $cbo_esc_dest . "tipo doc" . $Cbo_Tipo_Docto . "destino " . $TxtInterno;
//echo "usuario" . $idusuario . "c" .$cusuario ."f". $idfuncionario;
...
{	
        ...
        if(archivo == "") { 
          ...
          alert('Debe especificar un documento(GIF) antes de hacer click en "Subir"');
        }
...
<!--form name="form1" method="post" action="cierra_tramite2.php"-->
    ...
    <table width="650" border="1" cellpadding="1" cellspacing="0" bgcolor="#e6eeff">
      ...
      <tr> 
        <td> 
          ...
          <table width="100%" height="152" border="1" cellpadding="1" cellspacing="0">
            <tr> 
          ...
          <table border="0">
            <tr> 
              <td width="626"><div align="center"> 
   		          <INPUT TYPE="button" VALUE="Subir Archivo" onclick="sube_imagen();">
                  <!--input name="cmd_grabar" type="submit"  value="Asociar Archivo" onclick="sube_imagen();"-->
