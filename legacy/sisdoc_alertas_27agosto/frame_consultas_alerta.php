...
{
echo "alert('Código no existe');";
echo ' parent.mainFrame.document.form1.Txttema.value="";' . ";\n";
}
...
if ($sw=="OTE" and $nom_dep !="")
 {  
$rs_plazo= mssql_query("select a.id_tema,a.desc_tema,b.plazo_limite_dias from temas_alertas a ,tipo_compromiso2 b ,dependencia_externa c  where c.cod_dependencia_externa=$dep and c.id_dependencia_externa=b.id_dependencia   and b.id_tema = a.id_tema  and b.id_tema = $cod  order by a.desc_tema", $cn);
