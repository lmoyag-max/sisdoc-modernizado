...
<table width="100%" border="0" background="images/azul2.jpg">
  <tr> 
     ...
     <td width="776">
     <!-- <img src="images/mas.gif" border="0"> -->
...
<table width="80%" border="0" background="images/azul2.jpg">
  <tr> 
     ...
     <td width="20%">
		 ...
		 <tr>
		 <!--<td bgcolor="#66FF00" width="33%" align="center">
		 <span onMouseOver="this.style.cursor='hand'; this.style.background='#FFFFFF'; this.style.color='#0000CC';" 
		 onMouseOut="this.style.background='#0000CC'; this.style.color='#FFFFFF';" onCLick="actualiza();"><?php echo $num_verde; ?>
		</span>
		 </td> -->
