...
while($reg_dep = mssql_fetch_array($rs_dep))
   {
        $i = $i + 1;
       echo "parent.mainFrame.document.form1.Cbo_Destinatario.options[" . $i . "].value='" . $reg_dep[id_dependencia] . "';\n";
       echo "parent.mainFrame.document.form1.Cbo_Destinatario.options[" . $i . "].text='" . $reg_dep[desc_dependencia] . "';\n";
	}
echo "</script>\n";
$reg_dep.close;
$rs_dep.close;
...
oCMenu.fromtop=25 //This is the left position of the menu. (Only in use if menuplacement below is 0 or aligned) (will change to adapt any borders) - Value: px || "%"
...
oCMenu.makeMenu('top1','','Ingreso','','mainFrame',91,21) //,'images/mnu_ingreso.gif')
        oCMenu.makeMenu('sub10','top1','Nuevo Documento','ingreso_docto1.php','mainFrame',100)
