...
//}
	...
	echo '<input type="hidden" name="existeoficial" value="0">';
	}
	if ($tot<>0) // en caso que ya exista numero oficial  y despliegue el mensaje 
	{
	echo '<input type="hidden" name="existeoficial" value="1">';
	echo '<input type="hidden" name="grabaok" value="0">';
