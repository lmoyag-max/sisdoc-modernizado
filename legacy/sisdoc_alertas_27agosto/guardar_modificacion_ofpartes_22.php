...
$sw=1;
//echo "fecha oficial 1 " . $Txtfechaofic. "<br>";
...
//echo "fecha oficial  2 " . $Txtfechaofic. "<br>";

//echo "origen " .  $cbotiporig ."<br>";
echo "documento" . $iddocumento 	;
...
//echo "documento query ". $documento_query;
$rs_doc = mssql_query($documento_query,$cn); 
$reg_doc = mssql_fetch_array($rs_doc);
//}
  //echo "origen" . $cbotiporig . "tipo" . $Cbo_Tipo_Docto;
...
// se gragan estas 2 lineas para efectos de que graba igual si  el numero oficial  ya existe 
	echo '<input type="hidden" name="existeoficial" value="3">';
	echo '<input type="hidden" name="grabaok" value="1">';
	}
	echo "</form></body></html>";
