<HTML>
<HEAD>
<TITLE>Sistema Control de Documentos  </TITLE>
...
<BODY marginwidth="0" marginheight="0" onLoad="javascript:asample1();">
<p><img src="file://///Linux80/desarrollo/reforma/logo_chico.gif"></p>
<p align="center"><b><font size="5" > Sistema de Control de Documentos</font></b></p>
<DIV id=isample1b style="VISIBILITY: hidden; OVERFLOW: hidden; POSITION: absolute; TOP: -1000px; HEIGHT: 10px">
        ...
        <TBODY>
          <TR>
            ...
            <TD style="FONT-SIZE: 11px; COLOR: white; FONT-FAMILY: verdana,arial" vAlign=center noWrap height=15>
              <IMG height=6 src="file://///Linux80/desarrollo/reforma/images/arrow_test.gif" width=6 border=0>&nbsp;&nbsp;Ingrese su RUT y contrase&ntilde;a
            </TD>
          </TR>
        </TBODY>
      </TABLE>
    </SPAN>
    <SPAN id=lsample1 style="LEFT: 230px; WIDTH: 11px; CURSOR: hand; POSITION: absolute; TOP: 2px; HEIGHT: 11px">
      <IMG height=11 src="file://///Linux80/desarrollo/reforma/images/closebox_small.gif" width=11>
    </SPAN> 
  </DIV>
  <DIV id=isample1m style="VISIBILITY: hidden; POSITION: absolute; bgcolor: 'Color [A=255, R=239, G=243, B=247]'">
	...
	<TR>
          ...
          <TD noWrap>  
            <input type="text" name="el_rut" maxlength="12" size="10" onChange="verificarRutGeneral(document.formurut.el_rut.value,0,0);" >
            <input type="hidden" name="rut" maxlength="12">			
          </TD>
        </TR>
        <TR>
          <TD>&nbsp;
          ...
          <TD noWrap>
            <FONT style="FONT-SIZE: 10px; FONT-FAMILY: verdana,arial">
            Contrase&ntilde;a :&nbsp;</FONT>
          </TD>
          <TD noWrap>  
            <input type="password" name="clave" maxlength="12" size="10">
        ...
        <TR align="center">
          <TD colspan="3">
             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" style="color:#FFFFFF;background-color:#6B8EC6;" name="inGRESAR" value="Ingresar" onClick="ingresa()" /><br>
          </TD>
        </TR>
      </TBODY>
    </TABLE>
        ...
        <TBODY>
          <TR>
            ...
            <TD style="FONT-SIZE: 9px; COLOR: black; FONT-FAMILY: verdana,arial" vAlign=center noWrap height=7>
              <IMG height=7 src="file://///Linux80/desarrollo/reforma/images/arr_silver.gif" width=9 border=0>
              &nbsp;
		<!--B>Departamento de Inform&aacute;tica<BR><center>Consultas: 6300527</center></B-->
			 <B>Departamento de Inform&aacute;tica</B>
			 </TD>
			            			 
            </TBODY>
      </TABLE>
    </SPAN>
    <SPAN id=isample1p style="LEFT: 100px; WIDTH: 15px; CURSOR: nw-resize; POSITION: absolute; TOP: 10px; HEIGHT: 15px">
      <IMG height=15 src="file://///Linux80/desarrollo/reforma/images/resize_blue.gif" width=15>
    </SPAN> 
  </DIV>
</DIV>
<SCRIPT language=javascript>
<!--
 ...
 function amsample1(x,y,m)
 {
  ...
  function asample1()
  {
    ...
    var h=190;
    var w=230;
    y = document.body.offsetHeight/2 - 210/2 + document.body.scrollTop;
    x = document.body.offsetWidth/2 - 230/2 + document.body.scrollLeft;
    if(msample1 != null)
    {  
      alsample1();
      apsample1(w,h,true);
