...
function deriva_docto()
{
 ...
 document.form1.submit();
// location.href="deriva_sdoc.php"  ;
 <?php echo 'location.href="deriva_sdoc.php?idusuario=' . $idusuario . "&flujook=" . $flujo . 
 "&cusuario=" . $cusuario .  "&iddocum=" . $iddocum .  "&num_int=" . $numint . 
 "&idfuncionario=" . $idfuncionario .  "&accion=" . 1 .  "&origen=" . $dedonde . "&idseguim=" . $idseguim . '";';?> 
...
<?php echo 'location.href="derivar_con_docto.php?idusuario=' . $idusuario . "&flujook=" . $flujo . 
 "&cusuario=" . $cusuario .  "&iddocum=" . $iddocum .  "&num_int=" . $numint . 
 "&idfuncionario=" . $idfuncionario .  "&accion=" . 1 . "&idseguim=" . $idseguim . '";';?> 
}
...
<?php echo 'location.href="responder_con_docto.php?idusuario=' . $idusuario . "&flujook=" . $flujo . 
 "&cusuario=" . $cusuario .  "&iddocum=" . $iddocum .  "&num_int=" . $numint . 
 "&idfuncionario=" . $idfuncionario .  "&accion=" . 2 .  "&idseguim=" . $idseguim . '";';?> 
}

function respuesta_docto() 
{
  document.form1.submit();
 // location.href="resp_sindoc.php"  ;
              ...
              <td> <table width="100%" border="0" cellpadding="2" cellspacing="2">
                ...
                <table width="100%" border="0">
                  <tr> 
                    ...
                    <td> 
					<textarea name ="observacion" cols="70" rows="4" onFocus="this.blur();"><?echo $rs[observaciones]?></textarea> 
                    </td>
                  </tr>
                </table></td>
            </tr>
