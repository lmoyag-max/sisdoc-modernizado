...
<table width="80%" border="0" background="images/azul2.jpg">
  <tr> 
     <td width="17%">
     ...
     <td width="3%">
        <div align="right"><img src="images/logo40.gif" width="46" height="42"></div>
     </td>
</tr>
</table>
 ...
 */        //oCMenu.makeMenu('sub16','top1','Ingreso Oficina de partes con alerta ','ingreso_ofpartes_k_alerta.php?cusuario=<?php echo $cusuario;	?>&idusuario=<?php echo $idusuario;?>&idfuncionario=<?php echo $idfuncionario;?>&flujook=<?php echo $flujook;?>&num_int=<?php echo $num_int;?>&num_exp=<?php echo 0;?>&sw_ext=0','mainFrame',150)
		oCMenu.makeMenu('sub16','top1','Ingreso Oficina de partes con alerta ','ingreso_ofpartes_k_alerta2.php?cusuario=<?php echo $cusuario;	?>&idusuario=<?php echo $idusuario;?>&idfuncionario=<?php echo $idfuncionario;?>&flujook=<?php echo $flujook;?>&num_int=<?php echo $num_int;?>&num_exp=<?php echo 0;?>&sw_ext=0','mainFrame',150)
		oCMenu.makeMenu('sub12','top1','Ingreso Numero Oficial ','modifica_docto_ofpartes.php?cusuario=<?php echo $cusuario;?>&idusuario=<?php echo $idusuario;?>&idfuncionario=<?php echo $idfuncionario;?>&flujook=<?php echo $flujook;?>&num_int=<?php echo $num_int;?>&mensaje=<?php echo "1";?>','mainFrame',150)		
		oCMenu.makeMenu('sub13','top1','Modificación Numero Oficial','modifica_docto_modpartes.php?cusuario=<?php echo $cusuario;?>&idusuario=<?php echo $idusuario;?>&idfuncionario=<?php echo $idfuncionario;?>&flujook=<?php echo $flujook;?>&num_int=<?php echo $num_int;?>','mainFrame',150)		
		oCMenu.makeMenu('sub17','top1','Modificación de Documento (alerta)','modifica_docto_alerta.php?cusuario=<?php echo $cusuario;?>&idusuario=<?php echo $idusuario;?>&idfuncionario=<?php echo $idfuncionario;?>&flujook=<?php echo $flujook;?>&num_int=<?php echo $num_int;?>','mainFrame',150)		
		oCMenu.makeMenu('sub18','top1','Modificación de Tramite(alerta)','busca_tramites_alerta.php?cusuario=<?php echo $cusuario;?>&idusuario=<?php echo $idusuario;?>&idfuncionario=<?php echo $idfuncionario;?>&flujook=<?php echo $flujook;?>','mainFrame',150)		
