...
$xx=$idusuario;
$fun=$idfuncionario;
//echo "nomina..." . $idnomina;
$nomina=$idnomina;
//echo "usua" . $cusuario . " *** idusu" . $idusuario . " *** fun" . $idfuncionario . " " . $fun;
...
<?php
 ...
 $rs_proc="select usuario.id_funcionario,dependencia.desc_dependencia
   ...
   where  usuario.id_usuario= $xx and 
    funcionario.id_funcionario = usuario.id_funcionario 
   and funcionario.id_dependencia=dependencia.id_dependencia and dependenciA.vigencia IS  null ";
...
<table width="720" border="0" align="center" cellpadding="1" cellspacing="1">
  <tr> 
    ...
    <td width="310"> <div align="center"><strong><font color="#0000A0" size="3">NOMINA 
        DE DOCUMENTOS DESPACHADOS </font></strong></div></td>
...
<table width="720" border="0" align="center" cellpadding="1" cellspacing="1">
  <tr> 
    ...
    <td width="310"> <div align="center"><strong><font color="#0000A0" size="3"><? echo "Emitido por : " . $rs[desc_dependencia]?></font></strong></div></td>
    <td width="179"><div align="right"></div></td>
  </tr>
</table>
<table width="720" align="center" border="0" cellspacing="1" cellpadding="1">
  <tr> 
    ...
    <td width="317" height="26"  valign="middle"> 
      <div align="center"><font color="#0000A0" size="3"><? echo "NOMINA : " . $nomina?></font></div></td>
    <td width="110" height="26"  valign="middle" align="right" ><div align="left"></div></td>
    <td width="122"  valign="middle" align="right" > <div align="left"></div></td>
  </tr>
</table>

<table width="720" align="center" border="0" cellspacing="1" cellpadding="1">
  <tr> 
    <td width="158" height="26" ><strong></strong></td>
    <td width="290" height="26"  valign="middle"> <div align="center"></div></td>
    <td width="107" height="26"  valign="middle" align="right" ><div align="left"><font color="#0000A0" size="2" >Fecha 
        Despacho</font><font color="#0000A0" >:</font></div></td>
    <td width="152"  valign="middle" align="right" > <div align="left"><font color="#0000A0" size="2" ><?php echo $fechax;?></font></div></td>
  </tr>
</table>
<table width="720" align="center" border="0" cellspacing="1" cellpadding="1">
  <tr> 
    <td width="158" height="26" ><strong></strong></td>
    <td width="290" height="26"  valign="middle"> <div align="center"></div></td>
    <td width="107" height="26"  valign="middle" align="right" ><div align="left"><font color="#0000A0" size="2" >Hora 
        Emisi&oacute;n : </font></div></td>
    <td width="152"  valign="middle" align="right" > <div align="left"><font color="#0000A0" size="2" ><?php echo $horax. " ". "Hrs.";?></font></div></td>
  </tr>
</table>
<table width="720" border="0" align="center" cellpadding="1" cellspacing="1">
  <tr> 
    <td width="157" height="60"> 
      <div id="impresion" style="position:absolute; z-index:1; visibility: visible; overflow: auto; background-color: #ffffff; layer-background-color: #ffffff; border: 1px none #000000; left: 643px; top: 204px; width: 178px; height: 39px;"> 
    ...
    <td width="350"> 
      <div id="volver" style="position:absolute; z-index:1; visibility: visible; overflow: auto; background-color: #ffffff; layer-background-color: #ffffff; border: 1px none #000000; left: 631px; top: 30px; width: 119px; height: 41px;"> 
        <table width="42%" height="35" align="right">
          <tr> 
...
$rs_recep="exec busca_nomina_imprime '" . $xx .  "','" . $nomina . "'";
...
echo '<td heigth="45" valign="top" width="145"><div align="left"><font size="2" color="#FFFFFF"><strong>Materia</strong></font></div></td>';
...
echo '<td width="45" height="28"  valign="top"> <div align="left"><font color="#000000" size="2"> 
        Nro Interno</font></div></td>';
echo '<td width="45"  valign="top" heigth="45"> <div align="left"><font color="#000000" size="2"> 
        Nro Oficial</font></div></td>';
echo '<td width="54"  valign="top" heigth="45"> <div align="left"><font color="#000000" size="2"> 
        Nro Externo</font></div></td>';
echo '<td width="70"  valign="top" heigth="45"> <div align="left"><font color="#000000" size="2"> 
        Tipo<br>
        Docto</font></div></td>';
echo '<td width="135"  valign="top" heigth="45"> <div align="left"><font color="#000000" size="2"> 
        Materia</font></div></td>';
echo '<td width="70"  valign="top" heigth="45"> <div align="left"><font color="#000000" size="2"> 
        Procedencia</font></div></td>';
echo '<td width="70"  valign="top" heigth="45"> <div align="left"><font color="#000000" size="2"> 
        Destinatario</font></div></td>';
echo '<td width="50"  valign="top" heigth="45"> <div align="left"><font color="#000000" size="2"> 
        Fecha<br>
        Docto</font></div></td>';
echo '<td width="70"  valign="top" heigth="45"> <div align="left"><font color="#000000" size="2"> 
        Observación</font></div></td>';
echo '<td width="80"  valign="top" heigth="45"> <div align="left"><font color="#000000" size="2"> 
        Firma</font></div></td>';		
echo '</tr>';
}
...
?>
  <tr> 
    ...
    <td align="left" width="135" valign="middle"><font size="2"><?php if ($qr["materia"]=="")
		           echo "&nbsp";
	...
	<td align="left" width="60" valign="middle"><font size="2"><?php if ($qr["observaciones"]=="")
		           echo "&nbsp";
