...
<table align="center" width="639" height="35" border="0">
  <tr> 
    ...
    <td width="88"><div align="right"><strong><font color="#000000" ><?php echo '<a href="busca_pend.php?cusuario=' . $cusuario .
...
<?php
// ------------ Busca documentos pendientes por fecha_ini y fecha_fin  , busca los documentos no recepcionados, sin otro tramite a continuacion del tramite  y los que no han tenido respuesta desde el destino -------------------
...
// buscando por tipo de documento //
if ( $Cbo_Tipo_Docto== 0 ){
 $cbo_tipo= "";
 }
else{
...
//	  $mat2 =  "b.observaciones like '%" . trim($vector[$x]) . "%'";
	  $mat3 = $mat3 . "and ((" . $mat1 . " ) )" ;  
